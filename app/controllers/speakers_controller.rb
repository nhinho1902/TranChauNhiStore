class SpeakersController < ApplicationController
  ...
  private
    ...
    def speaker_params
      params.require(:speaker).permit(:Speaker_ID, :Speaker_Name, :Topic_Name, :Bio, :Contact_Number, :Email, :Address, :DOB, :Personal_ID, :Image_File, :Social_Media_Link, :Person_in_Charge, :Note)
    end
end
