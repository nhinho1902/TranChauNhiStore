class SponsorsController < ApplicationController
  ...
  private
    ...
    def sponsor_params
      params.require(:sponsor).permit(:Sponsor_ID, :Sponsor_Name, :Contact_Number, :Email, :Address, :Sponsor_Type, :Sponsorship_Level, :Image_File, :Website_Link, :Contract_File, :Person_in_Charge, :Note)
    end
end
